                ...
                <div class= "card text-center border-info mb-3 " style = "width: 18rem;">
                    <!--<img class="card-img-top" src=".../100px180/" alt="Card image cap">-->
                        <div class = "card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">{{ $advertentie->categorie }}</h6>
                            <p class = "card-text">{{ $advertentie->omschrijving }}<br/>
                            aangeboden door: {{ $advertentie->naamVerkoper }}<br/>
                            vraagprijs: {{ $advertentie->vraagprijs }}<br/>
                         <!--   geplaatst op:{{ $advertentie->plaatsingsdatum }}<br/>
                            </p>
